...
#     map = {'NOUN': 'N', 'VERB': 'V', 'ADJ': 'AJ', 'ADV': 'ADV', 'PR': 'PRO', 'PREM': 'DET', 'PREP': 'P', 'POSTP': 'POSTP', 'PRENUM': 'NUM', 'CONJ': 'CONJ', 'PUNC': 'PUNC', 'SUBR': 'CONJ'}
...
if __name__ == '__main__':
    reader = NewDadeganReader('/repo/ebi/dadegan/new_version/UD_Persian-PerDT/not-to-release/Dadegan_univ_tok/dev.conllu')
    print(next(reader.sents()))
    print(tree2brackets(next(reader.chunked_trees())))